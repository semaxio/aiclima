...
const Card = ({ item, page }: { item: ProductCard, page: number }) => {
  const {
    article,
    brand,
    name,
  ...
  return (
    <div className="relative bg-white rounded-[5px] shadow-md overflow-hidden md:max-w-2xl w-[240px] pb-[35px]">
      {/* Галерея изображений */}
      ...
      <BasketButton
        className="absolute w-[80%] bottom-[10px] left-[50%] translate-x-[-50%]"
