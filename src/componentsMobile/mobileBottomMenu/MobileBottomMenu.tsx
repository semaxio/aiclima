...
export default function MobileBottomMenu() {
  ...
  return (
    <div
      ...
      <Link onClick={removeLocalStorage} href="/" className="flex flex-col gap-[10px] items-center"><Image
        width={22} height={22} src={Homepage} alt={'Homepage'} />Главная</Link>
      <Link onClick={removeLocalStorage} href="/catalog" className="flex flex-col gap-[10px] items-center"><Image
